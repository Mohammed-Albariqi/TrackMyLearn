            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to TrackMyLearn.
                </p>
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to TrackMyLearn, accessible from
                https://localhost:3000 for now.
              </li>{" "}
              <li>
                <strong>Service</strong> refers to the Website.
              </li>
              <li>
                <strong>Country</strong> refers to: Saudi Arabia, Jeddah
              </li>
              <li>
                <p>
